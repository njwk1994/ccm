...
public class FlowDefinitionController {
    ...
    public Result list(@ApiParam(value = "当前页码", required = true) @RequestParam Integer pageNum, @ApiParam(value = "每页条数", required = true) @RequestParam Integer pageSize, FlowProcDefDto flowProcDefDto) {
    ...
    @PostMapping("/import")
    public Result importFile(@RequestParam(required = false) String name, @RequestParam(required = false) String category, MultipartFile file) {
        InputStream in = null;
        try {
    ...
    public Result startByProcDefId(@ApiParam(value = "流程定义id") @PathVariable(value = "procDefId") String procDefId, @ApiParam(value = "变量集合,json对象") @RequestBody Map<String, Object> variables) {
    ...
    public Result startByProcDefKey(@ApiParam(value = "流程定义id") @PathVariable(value = "procDefKey") String procDefKey, @ApiParam(value = "变量集合,json对象") @RequestBody Map<String, Object> variables) {
    ...
    public Result startByDataId(@ApiParam(value = "流程定义id") @PathVariable(value = "dataId") String dataId, @ApiParam(value = "变量集合,json对象") @RequestBody Map<String, Object> variables) {
    ...
    public Result updateState(@ApiParam(value = "1:激活,2:挂起", required = true) @RequestParam Integer state, @ApiParam(value = "流程部署ID", required = true) @RequestParam String deployId) {
    ...
    @ApiOperation(value = "指定流程办理部门")
    @GetMapping("/organizeList")
    public Result organizeList(SysDepart depart) {
        List<SysDepart> list = iFlowThirdService.getTreeDepart();
        return Result.OK(list);
    }
}
