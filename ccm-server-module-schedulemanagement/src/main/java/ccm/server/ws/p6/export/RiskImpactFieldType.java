...
/**
 * <p>RiskImpactFieldType的 Java 类。
 *
 * <p>以下模式片段指定包含在此类中的预期内容。
 * <pre>
 * &lt;simpleType name="RiskImpactFieldType"&gt;
 ...
 *
 */
@XmlType(name = "RiskImpactFieldType")
@XmlEnum
public enum RiskImpactFieldType {
    ...
    public static RiskImpactFieldType fromValue(String v) {
        for (RiskImpactFieldType c: RiskImpactFieldType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
