...
/**
 * <p>EPSFieldType的 Java 类。
 *
 * <p>以下模式片段指定包含在此类中的预期内容。
 * <pre>
 * &lt;simpleType name="EPSFieldType"&gt;
...
public enum EPSFieldType {
    ...
    public static EPSFieldType fromValue(String v) {
        for (EPSFieldType c: EPSFieldType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
