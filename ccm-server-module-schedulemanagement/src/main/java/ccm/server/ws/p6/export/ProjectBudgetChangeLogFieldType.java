...
/**
 * <p>ProjectBudgetChangeLogFieldType的 Java 类。
 *
 * <p>以下模式片段指定包含在此类中的预期内容。
 * <pre>
 * &lt;simpleType name="ProjectBudgetChangeLogFieldType"&gt;
 ...
 *
 */
@XmlType(name = "ProjectBudgetChangeLogFieldType")
@XmlEnum
public enum ProjectBudgetChangeLogFieldType {
    ...
    ProjectBudgetChangeLogFieldType(String v) {
        value = v;
    }
    ...
    public static ProjectBudgetChangeLogFieldType fromValue(String v) {
        for (ProjectBudgetChangeLogFieldType c: ProjectBudgetChangeLogFieldType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
