...
/**
 * <p>FundingSourceFieldType的 Java 类。
 *
 * <p>以下模式片段指定包含在此类中的预期内容。
 * <pre>
 * &lt;simpleType name="FundingSourceFieldType"&gt;
 ...
 *
 */
@XmlType(name = "FundingSourceFieldType")
@XmlEnum
public enum FundingSourceFieldType {
    ...
    FundingSourceFieldType(String v) {
        value = v;
    }
    ...
    public static FundingSourceFieldType fromValue(String v) {
        for (FundingSourceFieldType c: FundingSourceFieldType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
